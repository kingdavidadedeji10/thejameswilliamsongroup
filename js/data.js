...
const TEAM_DATA = [
  {
    ...
    phone: "",
    email: "info@jameswilliamsonrealtor.com",
    experience: "20 years",
  ...
  },
  {
    id: 2,
    name: "Emma Rodriguez",
    title: "Senior Interior Consultant",
    role: "Interior Consultant",
    specialty: ["Modern Design", "Color Consultation", "Space Planning"],
    bio: "Emma brings a fresh perspective to interior design with her background in architecture and passion for sustainable design. She creates spaces that are both beautiful and functional.",
    image: getRandomImage('team'),
    phone: "(555) 123-4568",
    email: "emma@jameswilliamsonrealtor.com",
    experience: "8 years",
    certifications: ["NCIDQ Certified", "LEED Green Associate"],
    achievements: ["Featured in Home & Design", "50+ Home Transformations", "Sustainability Award 2024"],
    socialMedia: {
      instagram: "emmadesigns",
      pinterest: "emmainteriors"
    },
    featured: true
  },
  {
    ...
    role: "Realtor",
    specialty: ["Luxury Estates", "Waterfront Properties", "Investment Analysis"],
    bio: "Michael specializes in high-end properties and investment opportunities. His analytical approach and market knowledge make him invaluable for luxury home buyers and investors.",
    image: getRandomImage('team'),
    phone: "(555) 123-4569",
    email: "michael@jameswilliamsonrealtor.com",
    experience: "12 years",
    certifications: ["Certified Luxury Home Marketing Specialist", "Real Estate Investment Advisor"],
    achievements: ["$50M+ in Sales", "Luxury Market Expert", "Investment Portfolio Specialist"],
    socialMedia: {
      linkedin: "michael-chen-realtor"
    },
    featured: true
  },
  {
    ...
    role: "Interior Consultant",
    specialty: ["Home Staging", "Contemporary Design", "Renovation Consultation"],
    bio: "Sarah leads our interior design team with over 10 years of experience in home staging and contemporary design. Her work has been featured in multiple design publications.",
    image: getRandomImage('team'),
    phone: "(555) 123-4570",
    email: "sarah@jameswilliamsonrealtor.com",
    experience: "10 years",
    certifications: ["ASP Certified Stager", "Interior Design Institute Graduate"],
    achievements: ["Staging Specialist of the Year", "Featured in 3 Magazines", "100+ Successful Stagings"],
    socialMedia: {
      instagram: "sarahjohnsondesign",
      houzz: "sarah-johnson-interiors"
    },
    featured: true
  },
  {
    ...
    role: "Realtor",
    specialty: ["First-Time Buyers", "FHA Loans", "Affordable Housing"],
    bio: "David is passionate about helping first-time buyers navigate the home buying process. His patient approach and extensive knowledge of financing options make him perfect for new buyers.",
    image: getRandomImage('team'),
    phone: "(555) 123-4571",
    email: "david@jameswilliamsonrealtor.com",
    experience: "6 years",
    certifications: ["First-Time Buyer Specialist", "FHA Loan Expert"],
    achievements: ["200+ First-Time Buyers Helped", "Client Education Champion", "Community Service Award"],
    socialMedia: {
  ...
  },
  {
    ...
    role: "Operations",
    specialty: ["Client Relations", "Transaction Coordination", "Team Management"],
    bio: "Jessica ensures all operations run smoothly and clients receive exceptional service throughout their journey. Her attention to detail and organization skills keep everything on track.",
    image: getRandomImage('team'),
    phone: "(555) 123-4572",
    email: "jessica@jameswilliamsonrealtor.com",
    experience: "7 years",
    certifications: ["Transaction Coordinator Certification", "Project Management Professional"],
    achievements: ["Operations Excellence Award", "100% Transaction Success Rate", "Client Satisfaction 98%"],
    socialMedia: {
      linkedin: "jessica-taylor-operations"
    },
    featured: false
  },
  {
    ...
    role: "Marketing",
    specialty: ["Digital Marketing", "Photography", "Social Media"],
    bio: "Alex manages all marketing efforts including professional photography, social media, and digital advertising to ensure maximum exposure for our properties.",
    image: getRandomImage('team'),
    phone: "(555) 123-4573",
    email: "alex@jameswilliamsonrealtor.com",
    experience: "4 years",
    certifications: ["Google Ads Certified", "Facebook Blueprint Certified"],
    achievements: ["Marketing Campaign of the Year", "50M+ Social Media Impressions", "Photography Award Winner"],
    socialMedia: {
      instagram: "alexmorganmarketing",
      linkedin: "alex-morgan-marketing"
    },
    featured: false
  },
  {
    ...
    role: "Support",
    specialty: ["Customer Service", "Follow-up Care", "Referral Program"],
    bio: "Lisa maintains relationships with past clients and ensures everyone receives ongoing support. She manages our referral program and keeps clients informed about market updates.",
    image: getRandomImage('team'),
    phone: "(555) 123-4574",
    email: "lisa@jameswilliamsonrealtor.com",
    experience: "5 years",
    certifications: ["Customer Service Excellence", "Real Estate Assistant Certification"],
    achievements: ["Client Retention Champion", "Referral Program Leader", "Service Excellence Award"],
    socialMedia: {
      linkedin: "lisa-wong-client-relations"
    },
    featured: false
  }
];
